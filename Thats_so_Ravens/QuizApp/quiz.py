...
class Quiz:
    ...
    def __init__(self, size):
        ...
        self.calibri_35 = pygame.font.SysFont('Calibri', helpers.normalize(self.size, 35, 'x'),True,False)
        self.calibri_18 = pygame.font.SysFont('Calibri', helpers.normalize(self.size, 18, 'x'),True,False)
...
############## End of INIT HELPERS
    ...
    def make_back(self, event):
        ...
        if (0 < mouse[0] < x_center*3) and (0 < mouse[1] < y_center*3):
